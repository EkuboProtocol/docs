...
Because the wallet executes plans rather than implementing protocols, its coverage extends well past Ekubo — currently 0x, Across, LayerZero, LI.FI, Aave V3, Morpho, Sky, Lido, and Merkl as well — and grows without a wallet update. See [Supported protocols](/wallet/protocols/), which also covers what makes a third-party MCP server compatible.
