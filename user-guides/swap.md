---
description: How to trade with Ekubo
---

# Swap

Ekubo does not have its own trading interface. Routing on Ekubo is an extremely challenging problem, and we believe the ecosystem can solve it better than we can.&#x20;
