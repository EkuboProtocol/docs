...
You will pay a `1000 USDC * 5 bips = 0.525 USDC` and `~0.952 ETH * 5 bips = 0.000476 ETH` fee to withdraw your liquidity. You can think of the withdrawal fee as paying a swap fee for the incurred benefit of rebalancing your liquidity.
